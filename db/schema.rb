...
ActiveRecord::Schema.define(version: 20170317203554) do
  ...
  create_table "application_settings", force: :cascade do |t|
    ...
    t.string "plantuml_url", limit: 255
    t.boolean "plantuml_enabled"
    t.integer "terminal_max_session_time", limit: 4, default: 0, null: false
    t.integer "unique_ips_limit_per_user", limit: 4
    t.integer "unique_ips_limit_time_window", limit: 4
    t.boolean "unique_ips_limit_enabled", default: false, null: false
    t.string "default_artifacts_expire_in", limit: 255, default: "0", null: false
  end
  ...
  create_table "chat_names", force: :cascade do |t|
    ...
    t.string "team_id", limit: 255, null: false
    t.string "team_domain", limit: 255
    t.string "chat_id", limit: 255, null: false
  ...
  create_table "chat_teams", force: :cascade do |t|
    t.integer "namespace_id", limit: 4, null: false
  ...
  add_index "ci_triggers", ["owner_id"], name: "fk_rails_e8e10d1964", using: :btree
  ...
  create_table "issues", force: :cascade do |t|
    ...
    t.integer "relative_position", limit: 4
  ...
  create_table "protected_branch_merge_access_levels", force: :cascade do |t|
    ...
    t.integer "access_level", limit: 4, default: 40, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "uploads", force: :cascade do |t|
    ...
    t.string "uploader", limit: 255, null: false
    t.datetime "created_at", null: false
  end
